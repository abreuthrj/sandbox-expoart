...
export function PostTitle(props: PostTitleType) {
  return (
    <div className="flex items-center justify-between w-full">
      <div className="flex gap-3">
        <div className="rounded-full overflow-hidden w-12 h-12 shadow-md">
          <Image src={props.avatar || DEFAULT_AVATAR} objectFit="cover" />
        </div>
...
export function PostContent(props: PostContentProps) {
  return (
    <div className="w-full my-10 relative">
      <Image src={DEFAULT_POST} objectFit="cover" layout="responsive" />
      ...
      <div className="absolute w-[120px] h-7 right-0 top-0 bg-[#D9D9D9AB] flex items-center justify-evenly rounded-bl-md">
        ...
        <div className="flex items-center">
          ...
          <span className="text-xs">{props.views}</span>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 w-full flex justify-center">
        ...
        >
          <svg
            ...
            height="48"
            width="48"
            fill={props.liked ? "#FF5151" : "#FFFFFF"}
          >
...
export default function Post(props: PostProps) {
  ...
  return (
    <div className="w-full mx-[16%] my-12">
      <PostTitle title={props.title} date={props.date} user={props.user} />
